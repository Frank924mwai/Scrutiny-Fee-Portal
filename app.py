...
# ── Portal Header Band ────────────────────────────────────────────────────────
header_html = (
    '<div style="background-color: #1E65B5; border-radius: 8px; border-bottom: 4px solid #C49A2A; padding: 20px 24px; margin-bottom: 28px; width: 100%; box-sizing: border-box;">'
    '    '
    '    <p style="margin: 0 0 10px 0; color: #FFFFFF !important; font-weight: 700; font-size: 1.1rem; letter-spacing: 0.05em; line-height: 1.3; text-transform: uppercase;">'
    '        Department of Town Planning and Estates Services'
    '    </p>'
    '    '
    '    '
    '    <div style="display: flex; flex-wrap: wrap; gap: 10px; align-items: center;">'
    '        <span style="background-color: #C49A2A; color: #1E65B5; font-size: 0.75rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; border-radius: 4px; padding: 4px 10px; display: inline-block;">'
    '            Charges Review Portal &nbsp;·&nbsp; Effective Rates'
    '        </span>'
    '        <span style="color: #E8EDF5 !important; font-size: 0.78rem; font-weight: 500; font-style: italic; display: inline-block;">'
