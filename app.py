...
/* Enhanced Form Touch Targets and Inputs */
div.stButton > button {
...
# ── Portal Header Band (CONFIDENTIAL: Protected Layout) ────────────────────
header_html = (
'<div class="portal-header">'
'  <p class="portal-title">Department of Town Planning and Estates Services</p>'
'  <div style="display: flex; flex-wrap: wrap; gap: 10px; align-items: center;">'
'    <span style="background-color: #C49A2A; color: #1E65B5; font-size: 0.72rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; border-radius: 4px; padding: 4px 10px; display: inline-block;">'
'      Charges Review 2026/2027 &nbsp;·&nbsp; Effective Rates'
'    </span>'
'    <span style="color: #FFFFFF !important; font-size: 0.78rem; font-weight: 500; font-style: italic; display: inline-block; letter-spacing: 0.02em;">'
    ...
    with col2:
        with st.container(border=True):
            ...
            if addon_accumulated > 0:
                ...
                '    <div>'
                '        <div style="font-size:0.72rem;color:#6B7A96;font-weight:600;text-transform:uppercase;letter-spacing:0.07em;">Base Fee</div>'
...
# ==============================================================================
    ...
    if search_query.strip():
        ...
        if len(match_idx) == 0:
            ...
            saved_steps = saved_steps_str.split(",") if (saved_steps_str and saved_steps_str != "nan" and saved_steps_str != "N/A") else []
            ...
            with st.form("tracker_form"):
                ...
                for i, title in enumerate(steps, 1):
                    ...
                    if checked: checked_states.append(title)
